...
type CollectionTest () =
    ...
    member __.Map () =
        ...
        let ra2 = cache.ToValue<Map<string, Person>>(ta2)
        let rb2 = cache.ToValue<Map<int, string>>(tb2)
    ...
    member __.Set () =
        ...
        let ra2 = cache.ToValue<Set<int>>(ta2)
        let rb2 = cache.ToValue<Set<string>>(tb2)
        let rc2 = cache.ToValue<Set<Person>>(tc2)
